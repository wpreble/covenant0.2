...
export const models: Models = {
    [ModelProviderName.OPENAI]: {
        ...
        model: {
            [ModelClass.SMALL]: {
                name: settings.SMALL_OPENAI_MODEL || "gpt-4-turbo-preview",
                stop: [],
            ...
            [ModelClass.MEDIUM]: {
                name: settings.MEDIUM_OPENAI_MODEL || "gpt-4-turbo-preview",
                stop: [],
                maxInputTokens: 128000,
                maxOutputTokens: 4096,
                frequency_penalty: 0.0,
            ...
            [ModelClass.LARGE]: {
                name: settings.LARGE_OPENAI_MODEL || "gpt-4-turbo-preview",
                stop: [],
                maxInputTokens: 128000,
                maxOutputTokens: 4096,
                frequency_penalty: 0.0,
